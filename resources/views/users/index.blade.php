                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('users.destroy',$user->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                     @method('DELETE')
                                                    <button onclick="return confirm('¿ESTAS SEGURO DE QUE DESEAS BORRAR AL USUARIO');"  type="submit" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i> BORRAR</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
